...
var _oddError_object = __webpack_require__(3);

var _oddError_object2 = _interopRequireDefault(_oddError_object);

var _oddFetching_data_options_service = __webpack_require__(4);
...
var Base = function () {
  function Base() {
    ...
    this.errors = new _oddError_object2.default();
  }
  ...
  _createClass(Base, [{
    ...
    value: function save() {
      if (this.isNewRecord()) {
        return _axios2.default.post(this.apiBasePath(), this.requestBody());
      }
      return _axios2.default.put(this.apiBasePath() + '/' + this.id, this.requestBody());
    }
    ...
    value: function destroy() {
      return _axios2.default.delete(this.apiBasePath() + '/' + this.id);
    }
    ...
    key: 'apiBasePath',
    value: function apiBasePath() {
      return OPTIONS.get(this).apiPath + '/' + OPTIONS.get(this).apiVersion + '/' + OPTIONS.get(this).scope + '/' + OPTIONS.get(this).resourceType;
    }
  }, {
    key: 'attributes',
    ...
    value: function all() {
      ...
      return _axios2.default.get(new this().apiBasePath() + '?' + _oddFetching_data_options_service2.default.call(options));
    }
    ...
    value: function find(id) {
      ...
      return _axios2.default.get(new this().apiBasePath() + '/' + id + '?' + _oddFetching_data_options_service2.default.call(options));
    }
  }]);
